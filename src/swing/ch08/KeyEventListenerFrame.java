...
/**
 * ket=yListener 인터페이스를 구현 하여 키보드 이벤트를 처리하는 클래스 설계
 * 1. JFrame 을 상속 받아 창 만들기
 * 2. KeyListener 를 구현하여 '감시자' 자격 을 갖춤
 */
...
public class KeyEventListenerFrame extends JFrame implements KeyListener {
    ...
    private void initData() {
        ...
        setResizable(false); // 사용자가 마우스 크기로 창 크기를 조절 못 하게 고정하는 옵션
    ...
    private void addEventListener() {
        // 핵심 개념
        // textArea 에게 키보드 입력이 들어오면 this(나) 한테 알려줘 라고 등록 하는 과정
        textArea.addKeyListener(this);
    }

    // ------------------- KeyListener 추상 메서드를 일반 메서드로 재정의
    // 문자가 입력 됐을 때 호출
    @Override
